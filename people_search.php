...
<div class='card'>
    <table class='table table-bordered'>
        ...
        $a=$_POST['first'];
        $b=$_POST['second'];
    $infor="SELECT transactions.*, account_heads.name  FROM transactions  join   account_heads on account_heads.id= transactions.account_head_id where people_id=$id and date between '$a' and '$b' ";
...
while($t=$r->fetch_assoc()){
    ...
    <tr>
        ...
        <td align="right"><?php echo number_format($t['amount'],2) ?></td>
